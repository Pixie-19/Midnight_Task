...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      proveEligibility: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(secretValue_0),
    ...
    this.impureCircuits = { proveEligibility: this.circuits.proveEligibility };
  ...
  _proveEligibility_0(context, partialProofData, secretValue_0) {
    const threshold_0 = 18n;
    const tmp_0 = secretValue_0 >= threshold_0;
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
